...
var publishLevel = function () {
    var ref = _asyncToGenerator(regeneratorRuntime.mark(function _callee(user_id, level_data) {
    ...
    return function publishLevel(_x11, _x12) {
        ...
        return regeneratorRuntime.wrap(function _callee2$(_context2) {
            while (1) {
                switch (_context2.prev = _context2.next) {
                    case 0:
                        _context2.next = 2;
                        return lol.getChampionByChampionId('TR', 2);
